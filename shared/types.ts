...
export type Project = { id: string, name: string, default_agent_working_dir: string | null, remote_project_id: string | null, working_directory: string | null, auto_run: boolean, created_at: Date, updated_at: Date, };

export type CreateProject = { name: string, repositories: Array<CreateProjectRepo>, working_directory: string | null, };

export type UpdateProject = { name?: string, auto_run?: boolean, };
